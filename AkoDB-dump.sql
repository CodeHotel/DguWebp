...
ALTER TABLE IF EXISTS ONLY public.list_progress DROP CONSTRAINT IF EXISTS list_progress_product_id_fk;
ALTER TABLE IF EXISTS ONLY public.list_progress DROP CONSTRAINT IF EXISTS list_progress_akouser_id_fk2;
ALTER TABLE IF EXISTS ONLY public.list_progress DROP CONSTRAINT IF EXISTS list_progress_akouser_id_fk;
...
ALTER TABLE IF EXISTS ONLY public.list_progress DROP CONSTRAINT IF EXISTS list_progress_pkey;
...
ALTER TABLE IF EXISTS public.list_progress ALTER COLUMN id DROP DEFAULT;
...
DROP TABLE IF EXISTS public.list_progress;
...
--
-- Name: list_progress; Type: TABLE; Schema: public; Owner: akomarket
--

CREATE TABLE public.list_progress (
    id integer NOT NULL,
...
ALTER TABLE public.list_progress OWNER TO akomarket;
...
ALTER SEQUENCE public.list_progress_id_seq OWNED BY public.list_progress.id;
...
--
-- Name: list_progress id; Type: DEFAULT; Schema: public; Owner: akomarket
--

ALTER TABLE ONLY public.list_progress ALTER COLUMN id SET DEFAULT nextval('public.list_progress_id_seq'::regclass);
...
--
-- Name: list_progress list_progress_pkey; Type: CONSTRAINT; Schema: public; Owner: akomarket
--

ALTER TABLE ONLY public.list_progress
...
--
-- Name: list_progress list_progress_akouser_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: akomarket
--
...
--
-- Name: list_progress list_progress_akouser_id_fk2; Type: FK CONSTRAINT; Schema: public; Owner: akomarket
--
...
--
-- Name: list_progress list_progress_product_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: akomarket
--
...
ALTER TABLE ONLY public.list_trade
    ADD CONSTRAINT list_trade_user_uid_fk FOREIGN KEY (owner_id) REFERENCES public.akouser(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.list_trade
    ADD CONSTRAINT list_trade_user_uid_fk2 FOREIGN KEY (buyer_id) REFERENCES public.akouser(id) ON DELETE SET NULL;
